...
object ParallelCountChange {
  ...
  // returns a threshold function that returns true
  // when the amount of money multiplied with the number of remaining coins
...
//    moneyThreshold(startingMoney)(money, coins) && totalCoinsThreshold(allCoins.length/2)(money, coins)
}
