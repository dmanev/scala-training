...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      if ($s_sc_MapLike$class__contains__sc_MapLike__O__Z(this$1, s)) {
        var this$2 = references;
        var x1$1 = this$2.get__O__s_Option(s);
        if ($is_s_Some(x1$1)) {
          ...
          if ((x === x1$1)) {
            ...
            var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
              return new $c_Lcalculator_Literal().init___D(0.0)
            }));
            var jsx$1 = new $c_Lcalculator_Signal().init___F0(expr$1)
          } else {
            var jsx$1;
            throw new $c_s_MatchError().init___O(x1$1)
          }
        };
        var temp$expr = $as_Lcalculator_Expr($as_Lcalculator_Signal(jsx$1).apply__O());
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      ...
      switch (x1) {
        default:
          return ((x1 > 14) ? "green" : (((x1 <= 14) && (x1 >= 0)) ? "orange" : "red"));
      }
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
...
$c_Lcalculator_Calculator$$anonfun$computeValues$2.prototype.apply__T2__T2 = (function(x$1) {
  if ((x$1 !== null)) {
    ...
    var sigExpr = $as_Lcalculator_Signal(x$1.$$und2$f);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, name$1, sigExpr$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(sigExpr$1.apply__O()), $as_sci_Map(arg$outer.namedExpressions$1$f.$$minus__O__sc_Map(name$1)))
      })
    })(this, name, sigExpr));
...
$c_Lcalculator_Polynomial$$anonfun$computeSolutions$1.prototype.apply__sci_Set = (function() {
  var x1 = $uD(this.delta$1$f.apply__O());
  if ((x1 > 0)) {
    var x1$2 = new $c_Lcalculator_Var().init___F0(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer) {
      return (function() {
        var jsx$1 = $uD(arg$outer.b$2$f.apply__O());
        var x = $uD(arg$outer.delta$1$f.apply__O());
        return (((-jsx$1) + $uD($g["Math"]["sqrt"](x))) / (2 * $uD(arg$outer.a$2$f.apply__O())))
      })
    })(this)));
    var x2 = new $c_Lcalculator_Var().init___F0(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer$1) {
      return (function() {
        var jsx$2 = $uD(arg$outer$1.b$2$f.apply__O());
        var x$1 = $uD(arg$outer$1.delta$1$f.apply__O());
        return (((-jsx$2) - $uD($g["Math"]["sqrt"](x$1))) / (2 * $uD(arg$outer$1.a$2$f.apply__O())))
      })
    })(this)));
    var array = [$uD(x1$2.apply__O()), $uD(x2.apply__O())];
    ...
    var array$1 = [((-$uD(this.b$2$f.apply__O())) / (2 * $uD(this.a$2$f.apply__O())))];
